...
Run the command npm install *lite-server --save-dev* (more information [here]("https://www.npmjs.com/package/lite-server"))
...
From the command line, in the project folder, run this command- *npm run dev*
